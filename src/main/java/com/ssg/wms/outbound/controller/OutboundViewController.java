...
public class OutboundViewController {
    ...
    public String showQuotationRequestDetailForm(@PathVariable("qrequest_index") Long qrequest_index) {
    ...
    public String showOutboundRequestDetailForm(@PathVariable("or_index") Long or_index) {
